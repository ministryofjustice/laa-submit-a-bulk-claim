...
public final class GetClaimPactTest extends AbstractPactTest {
  ...
  void verify200Response() {
    ClaimResponse submission = dataClaimsRestClient.getSubmissionClaim(submissionId, claimId).block();

    assertThat(submission).isNotNull();
    assertThat(submission.getId()).isEqualTo(claimId.toString());
    assertThat(submission.getSubmissionId()).isEqualTo(submissionId.toString());
  }
