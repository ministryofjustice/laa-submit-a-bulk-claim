...
class ViewSubmissionDetailInvalidPageViewTest extends ViewTestBase {

  ViewSubmissionDetailInvalidPageViewTest() {
  ...
  @Test
  void invalidSubmissionPageShowsValidationErrorBannerAndSummary() {
    ...
    assertPageHasContent(doc, "Rejected");
    assertPageHasContent(doc, "Resolve the errors and upload the file again.");
    assertPageHasContent(doc, "1 claim has errors for missing or incorrect information");
  }
}
