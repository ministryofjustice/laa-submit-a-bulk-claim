...
class DataClaimsRestClientIntegrationTest extends MockServerIntegrationTest {
  ...
  class GetBulkSubmission {
      ...
      void shouldHandle200Response() throws Exception {
          ...
          mockServerClient
                  .when(
                          HttpRequest.request()
                                  .withMethod("GET")
                                  .withPath("/api/v1/bulk-submissions/" + id))
                  .respond(
                          response()
                                  .withStatusCode(200)
                                  .withHeader("Content-Type", "application/json")
      ...
      void shouldHandle400Response() {
          ...
          // When
          assertThrows(
                  BadRequest.class, () -> dataClaimsRestClient.getBulkSubmission(id).block());
      }
      ...
      void shouldHandle401Response() {
          ...
          // When
          assertThrows(
                  Unauthorized.class, () -> dataClaimsRestClient.getBulkSubmission(id).block());
      }
      ...
      void shouldHandle500Response() {
          ...
          assertThrows(
                  InternalServerError.class,
                  () -> dataClaimsRestClient.getBulkSubmission(id).block());
      }
  }
  //------
