...
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.ClaimDetailsViewField.CLIENT_NAME;
...
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.ClaimDetailsViewField.ESCAPE_CASE;
...
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.ClaimDetailsViewField.PROFIT_COSTS;
...
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.ClaimDetailsViewField.UNIQUE_FILE_NUMBER;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.ClaimDetailsViewField.VAT;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.ClaimViewField.asLegalHelpField;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.ADJOURNED_HEARING_FEE;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.CATEGORY_OF_LAW;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.CMRH_ORAL;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.CMRH_TELEPHONE;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.COUNSELS_COSTS;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.DETENTION_TRAVEL_WAITING_COSTS;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.HOME_OFFICE_INTERVIEW;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.JR_FORM_FILLING;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.LONDON_RATE;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.MATTER_TYPE_1;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.MATTER_TYPE_2;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.SUBSTANTIVE_HEARING;
import static uk.gov.justice.laa.payments.submit.dto.submission.claim.viewmodels.viewfield.LegalHelpClaimDetailsViewField.TRAVEL_AND_WAITING_COSTS;
