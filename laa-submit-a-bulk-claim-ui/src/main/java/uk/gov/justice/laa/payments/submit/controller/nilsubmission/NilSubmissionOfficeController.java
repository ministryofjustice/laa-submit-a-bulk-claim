...
import static uk.gov.justice.laa.payments.submit.constants.NilSubmissionInfoMessageConstants.SUBMISSION_INFO_MESSAGE_PAGE_HEADING;
import static uk.gov.justice.laa.payments.submit.constants.NilSubmissionInfoMessageConstants.SUBMISSION_INFO_MESSAGE_TEXT;
import static uk.gov.justice.laa.payments.submit.constants.SessionConstants.NIL_SUBMISSION_FORM;
import static uk.gov.justice.laa.payments.submit.util.NilSubmissionSessionManager.cleanseSession;
import static uk.gov.justice.laa.payments.submit.util.NilSubmissionSessionManager.validateSessionState;
